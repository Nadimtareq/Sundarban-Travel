...
<head>
    ...
    <title>{{ config('app.name') }} @yield('title') Sunderban</title>
    ...
    <!-- flag icons -->
    <link rel="stylesheet" href="{{ asset('assetsh/icons/flags/flags.min.css') }}" media="all">



    <!-- altair admin -->
    <link rel="stylesheet" href="{{ asset('assetsh/css/main.min.css') }}" media="all">

    <!-- themes -->
    <link rel="stylesheet" href="{{ asset('assetsh/css/themes/themes_combined.min.css') }}" media="all">
    ...
    <link rel="stylesheet" href="{{ asset('assetsh/css/ie.css') }}" media="all">
    <![endif]-->
