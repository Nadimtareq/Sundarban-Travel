            ...
            <div class="col-md-3 pull-left">
                ...
                <div class="side-nav margin-bottom-60">
                    ...
                    <ul class="list-group list-group-bordered list-group-noicon uppercase">
                        <li class="list-group-item  "><a href="academic_program.html"><span class="size-11 text-muted pull-right"></span> Academic Programs</a></li>
                        <li class="list-group-item active"><a href="code_of_conducts.html"><span class="size-11 text-muted pull-right"></span> Code of Conducts</a></li>
