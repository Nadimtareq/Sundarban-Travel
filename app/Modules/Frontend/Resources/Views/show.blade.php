			...
			<section id="team">
				<div class="container">
					...
					<div class="masonry-gallery columns-5 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
						...
						<a class="image-hover" href="assets/images/demo/1200x800/24-min.jpg">
							<img src="assets/images/demo/600x400/24-min.jpg" alt="...">
						</a>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												...
												<select class="form-control pointer" name="contact[department]">
													...
													<option value="Marketing">Kualal Lumpur</option>
													<option value="Webdesign">Singapore</option>
													<option value="Architecture">Bangkok</option>
													<option value="Marketing">Kathmundu</option>
													<option value="Webdesign">Maldives & Colombo</option>
													<option value="Architecture">Agra & Goa</option>
													<option value="Marketing">Darjeeling & Mussoorie</option>
													<option value="Webdesign">Paris & Marseille</option>
												</select>
											</div>
										</div>
									</div>
