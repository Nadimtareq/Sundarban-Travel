...
<div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            <form action="{{route('commonpackge_store')}}"  method="post" enctype="multipart/form-data" class="uk-form-stacked" id="class_store">
                        ...
                        <div class="md-card">
                            <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname">  Common Package </span></h2>
                                </div>
                            </div>
                            <div class="user_content">
                                  <div class="uk-grid">
                                   <div class="uk-width-1-3">
                                    ...
                                    <div class="parsley-row">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}"  title="category" id="name" name="category" required data-md-selectize>
